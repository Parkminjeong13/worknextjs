    ...
    return (
        <>
            <div className="pl-0 box-border w-4/5 mx-auto my-40 md:w-9/10 md:pl-25">
                ...
                <div className={`w-9/10 grid grid-cols-10 gap-y-2 mx-auto mt-5 mb-20 overflow-hidden text-center bg-white border-red-500 border-2 py-[1.5%] shadow-[0_0_0_1px_#d12e2e] md:w-4/5 md:grid-cols-15 lg:overflow-visible lg:w-3/4 lg:grid-cols-20`}>
                    <HomeComponent />
                </div>
            </div>
        </>
